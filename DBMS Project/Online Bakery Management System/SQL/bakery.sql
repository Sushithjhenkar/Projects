...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2019 at 06:47 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `totalitems` ()  NO SQL
SELECT COUNT(*) as total from items$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `totalusers` ()  NO SQL
...
--
DELIMITER $$
CREATE TRIGGER `itemadded` AFTER INSERT ON `items` FOR EACH ROW insert into titems(name,price) values (new.name,new.price)
$$
DELIMITER ;
...
(7, 6, 'Mysore', '', '2019-11-29 15:23:57', 'Wallet', 0, 'Yet to be delivered', 0),
(8, 6, 'Mysore', '', '2019-11-29 15:30:30', 'Wallet', 650, 'Cancelled by Customer', 1);
...
INSERT INTO `titems` (`id`, `name`, `price`, `datetime`) VALUES
(1, '0', 150, '2019-11-29 08:59:37'),
(2, 'Sweet', 100, '2019-11-29 09:01:23');
...
INSERT INTO `tusers` (`id`, `name`, `action`, `datetime`) VALUES
(1, 'sushith', 'REGISTERED', '2019-11-29 08:46:21');
...
(6, 'Customer', 'sushith', 'sushith', 'sushith', NULL, NULL, 8762728971, 1, 0);

--
-- Triggers `users`
--
DELIMITER $$
CREATE TRIGGER `userlogs` AFTER INSERT ON `users` FOR EACH ROW INSERT into tusers(name,action) values(new.name,'REGISTERED')
$$
DELIMITER ;
...
INSERT INTO `wallet_details` (`id`, `wallet_id`, `number`, `cvv`) VALUES
(1, 1, '6155247490533921', 983),
(2, 2, '1887587142382050', 772),
(3, 3, '4595809639046830', 532),
(4, 4, '5475856443351234', 521),
(5, 5, '9076633115663264', 229),
(6, 6, '969487305108213', 518);
